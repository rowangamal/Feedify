...
public class SignupService {
    ...
    public void signupGoogle(UserSignupDTO userSignupDTO) throws NoSuchAlgorithmException {
    ...
    private User createUserFromDTOsignupGoogle(UserSignupDTO userSignupDTO) throws NoSuchAlgorithmException{
        User user = new User();
        user.setFName(userSignupDTO.getFirstName());
        user.setLName(userSignupDTO.getLastName());
        user.setUsername(userSignupDTO.getUsername());
